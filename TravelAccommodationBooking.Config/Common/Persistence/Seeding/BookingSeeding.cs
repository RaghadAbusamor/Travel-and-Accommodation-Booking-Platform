    ...
    public static IEnumerable<Booking> SeedData()
    {
        return new List<Booking>
        {
            new()
            {
                ...
                Price = 100,
                CheckInDate = DateTime.Parse("2024-08-20"),
                CheckOutDate = DateTime.Parse("2024-08-21"),
            ...
            new()
            {
                ...
                Price = 150,
                CheckInDate = DateTime.Parse("2024-08-05"),
                CheckOutDate = DateTime.Parse("2024-08-10"),
            ...
            new()
            {
                ...
                Price = 200,
                CheckInDate = DateTime.Parse("2024-08-12"),
                CheckOutDate = DateTime.Parse("2024-08-18"),
                BookingDate = DateTime.Parse("2024-08-05")
            }
        };
    }
}